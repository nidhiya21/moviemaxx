            ...
            <div id="addEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <cfparam name="form.fld_moviename" default=""> 
                        <cfparam name="form.fld_poster" default=""> 
                        <cfparam name="form.fld_details" default=""> 
                        <cfparam name="form.fld_cast" default=""> 
                        <cfparam name="form.fld_facts" default=""> 
                        <cfparam name="form.fld_link" default=""> 
                        <cfparam name="form.fld_ratings" default="">  
