<cfcomponent  accessors="true" output="false">
    ...
    <cffunction name="selectBookedSeat" hint="get seat details"  access="remote"  returntype="any" returnformat="JSON" output="false" >	 
        ...
        <cfquery name = "seatDet" result="pageResult" > 
            ...
            LEFT JOIN payment as payment
            ON cart.cartID  = payment.cartID 
            where showID=<cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.showID#"> AND orderStatus ="Success"
        </cfquery>
    ...
    <cffunction name="sendMessageWithTwilio" output="false" access="public" returnType="string">
        ...
        <cfset variables.twilioAuthToken = "1808b22c87fc8daf95f79bffc24c8a6d" /> 
